    ...
    steps: [
      {
        ...
        action: "click",
        check: { selector: ".unroll-finder__column:first-child .unroll-finder__item--group", count: 3 },
      },
      {
        title: "检查循环展开",
        text: "循环体按轮次分为 3 个分组；选择分组后，在下一栏查看该轮的测量。",
        target: ".unroll-finder__columns",
        check: { selector: ".unroll-finder__column:first-child .unroll-finder__item--group", count: 3 },
      },
      {
        title: "打开第一轮循环",
        text: "点击循环分组，在下一栏查看该轮的实际测量步骤。",
        target: ".unroll-finder__column:first-child .unroll-finder__item--group",
        action: "click",
        check: { selector: '.unroll-finder__item[data-step="1"]' },
      },
      {
        title: "选择测量步骤",
        text: "点击第一条测量查看参数和执行序号。",
        target: '.unroll-finder__item[data-step="1"]',
        action: "click",
        check: { selector: '.unroll-finder__item[data-step="1"][aria-pressed="true"]' },
      },
      {
        title: "返回画布",
