...
export const CurrentRampNode: React.FC<NodeComponentProps> = ({ node, onUpdate }) => {
  ...
  return (
    <div className="node-content">
      <div className="node-header">
        ...
        <span className="node-title">电流斜坡</span>
      </div>
      ...
      <div className="node-parameters">
        ...
        <ParameterInput
          label="起始电流 (A)"
          type="number"
          value={parameters.start_current}
          onChange={(value) => handleParameterChange('start_current', value)}
          step={0.001}
        />
        ...
        <ParameterInput
          label="终止电流 (A)"
          type="number"
          value={parameters.end_current}
          onChange={(value) => handleParameterChange('end_current', value)}
          step={0.001}
        />
