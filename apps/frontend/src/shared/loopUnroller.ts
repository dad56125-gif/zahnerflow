 ...
 */
function findMatchingLoopEnd(nodes: WorkflowNode[], loopStartIdx: number): number {
    let depth = 0;
 ...
 * ```
 */
export function unrollLoops(nodes: WorkflowNode[]): UnrollResult {
    // 执行递归展开
