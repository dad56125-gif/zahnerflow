...
状态：派生产物（研究优先级）。归属：Thales 研究任务。来源：本机 `archive/thales-xt-5.9.5-research/tools/select_focus.py` 与原件清单；由脚本生成，勿单独手改分类或数量。目录迁移复核：2026-09-20。重生成命令及边界见 [来源登记](../../architecture/source-of-truth.md)。
