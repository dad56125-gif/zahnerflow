...
归档状态：本文是 `.memory/changelog.md` 在 2026-07-09 压缩为设计变更索引前的完整原文。它用于追溯 1.0.0 形成过程，不再作为日常 changelog 入口。
...
1.0.0 已作为完成版本封存。本文保留按设计锚点组织的历史演进记录；面向版本复盘的汇总、归类、冲突处理和后续版本提示见 `doc/insight/1.0.0/`。
