...
归档状态：本文是 `.memory/design.md` 在 2026-07-09 压缩为当前设计基线前的完整原文。它用于追溯 1.0.0 形成时的详细约束，不再作为日常设计入口。
...
1.0.0 已作为完成版本封存。当前文件仍是 1.0.0 最终设计基线的权威入口；版本级归档、废弃方案、复盘结论和后续版本提示见 `doc/insight/1.0.0/`。
